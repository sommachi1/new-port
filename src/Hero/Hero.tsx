  ...
  return (
    <section className="home" id="home">
      <div className="home-content">
        ...
        <p>Welcome, i bring ideas to life on the web.Currently, I'm focused on building functional & responsive websites</p>
        ...
        <div><a href="./assets/Favour_Mmesomachi_Tech_CV.pdf" className="btn" target="_blank">
  View CV
</a>
</div>
      </div>
